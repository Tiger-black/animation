...
var Zepto = function () {
    ...
    var E, T, j, C, S, N, A = [], P = A.concat, O = A.filter, M = A.slice, D = window.document, k = {}, L = {}, Z = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, $ = /^\s*<(\w+|!)[^>]*>/, F = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, R = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, q = /^(?:body|html)$/i, z = /([A-Z])/g, I = ["val", "css", "html", "text", "data", "width", "height", "offset"], _ = ["after", "prepend", "before", "append"], W = D.createElement("table"), H = D.createElement("tr"), U = {
        ...
        th: H,
        "*": D.createElement("div")
    }, X = /complete|loaded|interactive/, B = /^[\w-]*$/, V = {}, Y = V.toString, G = {}, J = D.createElement("div"), Q = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return G.matches = function (t, e) {
        ...
        if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && $.test(t))i = G.fragment(t, RegExp.$1, n), t = null; else {
            ...
            if (G.isZ(t))return t;
            if (K(t))i = a(t); else if (r(t))i = [t], t = null; else if ($.test(t))i = G.fragment(t.trim(), RegExp.$1, n), t = null; else {
                if (n !== E)return j(n).find(t);
                i = G.qsa(D, t)
            }
        }
        ...
        var n, i = "#" == e[0], r = !i && "." == e[0], o = i || r ? e.slice(1) : e, s = B.test(o);
        ...
        var n, i, r, o = [];
        if (s(t))for (i = 0; i < t.length; i++)n = e(t[i], i), null != n && o.push(n); else for (r in t)n = e(t[r], r), null != n && o.push(n);
        return u(o)
    }, j.each = function (t, e) {
        var n, i;
        if (s(t)) {
        ...
        wrap: function (t) {
            var n = e(t);
            if (this[0] && !n)var i = j(t).get(0), r = i.parentNode || this.length > 1;
        ...
        wrapInner: function (t) {
            var n = e(t);
            return this.each(function (e) {
                var i = j(this), r = i.contents(), o = n ? t.call(this, e) : t;
        ...
        attr: function (t, e) {
            ...
            return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                if (1 === this.nodeType)if (r(t))for (T in t)y(this, T, t[T]); else y(this, t, v(this, e, n, this.getAttribute(t)))
        ...
        offset: function (t) {
            if (t)return this.each(function (e) {
                var n = j(this), i = v(this, t, e, n.offset()), r = n.offsetParent().offset(), o = {
                    top: i.top - r.top,
                    left: i.left - r.left
                };
        ...
        css: function (e, n) {
            ...
            }); else for (T in e)e[T] || 0 === e[T] ? s += c(T) + ":" + f(T, e[T]) + ";" : this.each(function () {
        ...
        toggleClass: function (t, e) {
            return t ? this.each(function (n) {
                var i = j(this), r = v(this, t, n, w(this));
        ...
        j.fn[e] = function () {
            ...
            return o.length < 1 ? this : this.each(function (t, e) {
                ...
                o.forEach(function (t) {
                    if (s)t = t.cloneNode(!0); else if (!r)return j(t).remove();
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
        ...
        if (p && p.promise(S), u.crossDomain || E("X-Requested-With", "XMLHttpRequest"), E("Accept", x || "*/*"), (x = u.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(x)), (u.contentType || u.contentType !== !1 && u.data && "GET" != u.type.toUpperCase()) && E("Content-Type", u.contentType || "application/x-www-form-urlencoded"), u.headers)for (g in u.headers)E(g, u.headers[g]);
        if (S.setRequestHeader = E, S.onreadystatechange = function () {
                if (4 == S.readyState) {
                    ...
                    if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == T) {
                        if (d = d || l(u.mimeType || S.getResponseHeader("content-type")), "arraybuffer" == S.responseType || "blob" == S.responseType)e = S.response; else {
                            e = S.responseText;
                            try {
        ...
        var r, o = this, s = e.split(/\s/), a = p(e, n, i), u = a.success;
    ...
    t.Callbacks = function (e) {
        e = t.extend({}, e);
        var n, i, r, o, s, a, u = [], c = !e.once && [], l = function (t) {
                    ...
                    t.each(i, function (i, r) {
                        ...
                        s[r[1]](function () {
                            ...
                            if (n && t.isFunction(n.promise))n.promise().done(e.resolve).fail(e.reject).progress(e.notify); else {
                                var i = this === o ? e.promise() : this, s = a ? [n] : arguments;
                                e[r[0] + "With"](i, s)
                            }
                        })
                    }), n = null
    ...
    t.when = function (i) {
        var r, o, s, a = n.call(arguments), u = a.length, c = 0, l = 1 !== u || i && t.isFunction(i.promise) ? u : 0, f = 1 === l ? i : e(), h = function (t, e, i) {
            return function (o) {
                e[t] = this, i[t] = arguments.length > 1 ? n.call(arguments) : o, i === r ? f.notifyWith(e, i) : --l || f.resolveWith(e, i)
            }
        };
        if (u > 1)for (r = new Array(u), o = new Array(u), s = new Array(u); u > c; ++c)a[c] && t.isFunction(a[c].promise) ? a[c].promise().done(h(c, s, a)).fail(f.reject).progress(h(c, o, r)) : --l;
    ...
    }, "focusin focusout focus blur load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change spring keydown keypress keyup error".split(" ").forEach(function (e) {
        t.fn[e] = function (t) {
    ...
    t.each(m, function (t, n) {
        ...
        var w, x, b, E = {}, T = "", j = this, C = t.fx.transitionEnd, S = !1;
        if (r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i)E[l] = i, E[f] = r + "s", E[p] = g + "s", E[h] = d || "linear", C = t.fx.animationEnd; else {
            x = [];
    ...
    var r = window.document, o = (r.documentElement, t.fn.show), s = t.fn.hide, a = t.fn.toggle;
    ...
    t(document).ready(function () {
        ...
        "MSGesture" in window && (f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function (t) {
            ...
            (!(v = s(n, "up")) || o(n)) && (i(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? c = setTimeout(function () {
                ...
                var e = t.Event("tap");
                e.cancelTouch = r, h.el.trigger(e), h.isDoubleTap ? (h.el && h.el.trigger("doubleTap"), h = {}) : a = setTimeout(function () {
...
;
(function ($) {
    $.formatHref = function (url) {
        if (url.indexOf('http') == 0) {
            return url;
        }
        var _prot = window.location.protocol;
        var _href = window.location.host + window.location.pathname;
        var hrefarr = _href.split('/');
        var urlarr = url.split('/');
        var arr = []
        if (!_href.match('/$')) {
            hrefarr.length = hrefarr.length - 1;
        }
        ...
        return _prot + '//' + hrefarr.join('/') + '/' + arr.join('/');
    }

    //所有a链接 使用openwindow打开;
    if (window.BrBridge && BrBridge.env.isApp) {
        var rex = new RegExp(/^(http|https|..\/|\/|.\/)/);
        $('body').on('click', 'a', function (event) {
            var _href = $(this).attr('href');
            if (_href && (_href.indexOf('#') > 1 || rex.test(_href))) {
                _href = $.formatHref(_href);
                BrBridge.call('Common', 'openWindow', {url: _href}, function (data) {
                }, function (error) {
                });
